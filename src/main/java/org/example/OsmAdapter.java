...
public class OsmAdapter {
  ...
  public static void main(String[] args) throws SQLException {
    ...
    /*while (itr.hasNext()) {
      ...
      System.out.println("Getting Start node ID from Line "+ lineItr.getID()+ ":
    " + lineItr.getStartNode().getID());
    }*/
    Iterator<Node> itlrNodeClose = mapDb.findNodesCloseByCoordinate(
        51.21663319921368, 14.117331000000002, 1);
    Iterator<Line> itlrLineClose = mapDb.findLinesCloseByCoordinate(
        51.05496611566341, 13.727288054098223, 100000000);
